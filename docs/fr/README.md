...
||`direct-payment-helloasso`|Créer un processus de paiement sans double saisie via HelloAsso|[`hpf-direct-payment-helloasso`](https://github.com/search?q=repo%3AJ9rem%2Fyeswiki-extension-hpf%20hpf-direct-payment-helloasso&type=code)|
