...
import HpfImportTable from './components/HpfImportTable.js'
import SpinnerLoader from '../../bazar/presentation/javascripts/components/SpinnerLoader.js'

const rootsElements = ['.dynamic-hpf-import-memberships-action'];
const isVueJS3 = (typeof window.Vue.createApp == "function");

let appParams = {
    components: {HpfImportTable,SpinnerLoader},
    data(){
        return {
            isLoading: true
        }
